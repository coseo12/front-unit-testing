  ...
  return (
    <div className="w-full px-5 xl:px-0 mx-auto max-w-screen-xl">
      ...
      <div className="grid grid-cols-1 gap-3">
        {data?.getEpisodes.episodes?.map((episode, idx) => (
          <div key={idx} className="w-full border-2 border-blue-400 rounded-lg px-4 md:px-16 py-3 flex justify-between items-center">
